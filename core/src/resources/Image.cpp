...
void Image2D::BlitTo(Image2D& dst, unsigned dst_mip, unsigned src_mip, vk::ImageLayout start_src_layout, vk::ImageLayout start_dst_layout,
	...
	TransitionImageLayout(start_src_layout, vk::ImageLayout::eTransferSrcOptimal, vk::AccessFlagBits::eTransferRead, vk::AccessFlagBits::eTransferRead,
		vk::PipelineStageFlagBits::eTransfer, vk::PipelineStageFlagBits::eTransfer, cmd, src_mip, 1);
	...
	dst.TransitionImageLayout(start_dst_layout, vk::ImageLayout::eTransferDstOptimal, vk::AccessFlagBits::eTransferWrite, vk::AccessFlagBits::eTransferWrite,
		vk::PipelineStageFlagBits::eTransfer, vk::PipelineStageFlagBits::eTransfer, cmd, dst_mip, 1);
...
void Image2D::CreateImage(VmaAllocationCreateFlags flags) {
	if (m_owns_image) {
		...
		OGFX_VK_CHECK(vmaCreateImage(VkContext::GetAllocator(), &im_info, &alloc_info, reinterpret_cast<VkImage*>(&m_image), &m_allocation, nullptr));
	}
...
void Image2D::PipelineBarrier(vk::ImageLayout layout, vk::AccessFlags src_access, vk::AccessFlags dst_access,
	vk::PipelineStageFlags src_stage, vk::PipelineStageFlags dst_stage, vk::CommandBuffer buf, unsigned mip_level,
	unsigned level_count) {
	TransitionImageLayout(layout, layout, src_access, dst_access, src_stage, dst_stage, buf, mip_level, level_count);
}
...
vk::ImageSubresourceRange Image2D::GetFullSubresourceRange(vk::ImageAspectFlags aspect_mask) const {
...
vk::WriteDescriptorSet Image2D::GetWriteDescriptorSet(uint32_t binding, vk::DescriptorImageInfo* image_info) const {
